...
htmlAhref =: {{
  NB. x starts with a # or a /, or INTERNAL_DOMAIN and INTERNAL_DOMAIN is not empty
  internal =. ('#/' e.~ {. x) +. (INTERNAL_DOMAIN -.@:-: '') *. {. INTERNAL_DOMAIN E. x
  class =. ('external-link';'internal-link') {~ internal
